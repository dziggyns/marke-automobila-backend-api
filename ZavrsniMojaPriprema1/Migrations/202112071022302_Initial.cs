namespace ZavrsniMojaPriprema1.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        KonjskihSnaga = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        Drzava = c.String(nullable: false, maxLength: 2),
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Automobils", "MarkaId", "dbo.Markas");
            ...
            DropIndex("dbo.Markas", new[] { "Naziv" });
            DropIndex("dbo.Automobils", new[] { "MarkaId" });
            DropIndex("dbo.Automobils", new[] { "Model" });
