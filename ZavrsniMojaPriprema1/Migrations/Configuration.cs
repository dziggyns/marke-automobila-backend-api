    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ZavrsniMojaPriprema1.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(ZavrsniMojaPriprema1.Models.ApplicationDbContext context)
        {
            ...
            context.Automobili.AddOrUpdate(
                ...
                new Models.Automobil() { Id = 11, Model = "Alfa 156", Cena = 48000m, GodinaProizvodnje = 1997, KonjskihSnaga = 190, MarkaId = 6 },
                new Models.Automobil() { Id = 12, Model = "Alfa 155", Cena = 44000m, GodinaProizvodnje = 1991, KonjskihSnaga = 170, MarkaId = 6 },
                new Models.Automobil() { Id = 13, Model = "Alfa 154", Cena = 38000m, GodinaProizvodnje = 1987, KonjskihSnaga = 150, MarkaId = 6 },
